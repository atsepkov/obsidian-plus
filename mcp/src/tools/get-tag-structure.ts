...
**Use this before batch_append_to_tag** to discover targetLine values for enrichment.

Returns for each bullet:
- line: Line number (use as targetLine in batch_append_to_tag)
- text: Bullet content
- indent: Indentation level (0 = direct child of tag)
- bullet: Bullet type (-, +, *)
- children: Nested child bullets

Example: Get structure, then enrich under specific bullets using their line numbers.`,
  inputSchema: {
