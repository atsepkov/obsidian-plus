...
export default class ObsidianPlus extends Plugin {
	...
	async onload() {
		...
		try {
			...
			console.error('obsidian-plus: Failed to load styles.css:', e);
		}
	...
	onunload() {
        ...
        private async initializeDataviewDependentFeatures() {
                ...
                // Initialize ServerManager for notebook-to-notebook sync
                ...
                // Initialize DelegateManager for vault-based trigger delegation
